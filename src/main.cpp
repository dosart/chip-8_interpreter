...
//    char const* romFilename = argv[3];
    ...
    int videoScale = 10; //std::stoi(argv[1]);
    int cycleDelay = 1; //std::stoi(argv[2]);
    char const* romFilename = "/home/dosart3/code/c++/chip-8_interpreter/cmake-build-debug/test_opcode.ch8";

    platform_t platform("CHIP-8 Emulator", static_cast<int>(VIDEO_WIDTH * static_cast<unsigned int>(videoScale)),
                        static_cast<int>(VIDEO_HEIGHT * static_cast<unsigned int>(videoScale)), VIDEO_WIDTH, VIDEO_HEIGHT);
